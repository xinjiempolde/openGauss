...
void PostgresInitializer::InitNeuTransactionSender() {
  InitThread();
  ...
  u_sess->proc_cxt.MyProcPort->database_name = (char*)m_indbname;
  u_sess->proc_cxt.MyProcPort->user_name = (char*)m_username;
...
void PostgresInitializer::InitNeuResponseReceiver() {
  InitThread();
...
void PostgresInitializer::InitNeuApplyLogReceiver() {
  InitThread();
