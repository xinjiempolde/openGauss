...
// source: kv_dbserver.proto

#include "kv_dbserver.pb.h"
...
extern PROTOBUF_INTERNAL_EXPORT_kv_5fdbserver_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_KvDBData_kv_5fdbserver_2eproto;
namespace proto {
...
static void InitDefaultsscc_info_KvDBData_kv_5fdbserver_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_KvDBData_kv_5fdbserver_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_KvDBData_kv_5fdbserver_2eproto}, {}};

static void InitDefaultsscc_info_KvDBRequest_kv_5fdbserver_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_KvDBRequest_kv_5fdbserver_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_KvDBRequest_kv_5fdbserver_2eproto}, {
      &scc_info_KvDBData_kv_5fdbserver_2eproto.base,}};

static void InitDefaultsscc_info_KvDBResponse_kv_5fdbserver_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_KvDBResponse_kv_5fdbserver_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_KvDBResponse_kv_5fdbserver_2eproto}, {
      &scc_info_KvDBData_kv_5fdbserver_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_kv_5fdbserver_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_kv_5fdbserver_2eproto = nullptr;
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_kv_5fdbserver_2eproto[2];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_kv_5fdbserver_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_kv_5fdbserver_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021kv_dbserver.proto\022\005proto\032\021transaction."
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_kv_5fdbserver_2eproto_deps[1] = {
  &::descriptor_table_transaction_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_kv_5fdbserver_2eproto_sccs[3] = {
  &scc_info_KvDBData_kv_5fdbserver_2eproto.base,
  &scc_info_KvDBRequest_kv_5fdbserver_2eproto.base,
  &scc_info_KvDBResponse_kv_5fdbserver_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_kv_5fdbserver_2eproto_once;
static bool descriptor_table_kv_5fdbserver_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kv_5fdbserver_2eproto = {
  &descriptor_table_kv_5fdbserver_2eproto_initialized, descriptor_table_protodef_kv_5fdbserver_2eproto, "kv_dbserver.proto", 398,
  &descriptor_table_kv_5fdbserver_2eproto_once, descriptor_table_kv_5fdbserver_2eproto_sccs, descriptor_table_kv_5fdbserver_2eproto_deps, 3, 1,
  schemas, file_default_instances, TableStruct_kv_5fdbserver_2eproto::offsets,
  file_level_metadata_kv_5fdbserver_2eproto, 3, file_level_enum_descriptors_kv_5fdbserver_2eproto, file_level_service_descriptors_kv_5fdbserver_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_kv_5fdbserver_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_kv_5fdbserver_2eproto), true);
namespace proto {
...
void KvDBData::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_KvDBData_kv_5fdbserver_2eproto.base);
  key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  value_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void KvDBRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_KvDBRequest_kv_5fdbserver_2eproto.base);
}
...
void KvDBResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_KvDBResponse_kv_5fdbserver_2eproto.base);
  result_ = false;
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* KvDBGetService::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_kv_5fdbserver_2eproto);
  return file_level_service_descriptors_kv_5fdbserver_2eproto[0];
}
...
void KvDBGetService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_kv_5fdbserver_2eproto[0]);
  switch(method->index()) {
    case 0:
      Get(controller,
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* KvDBPutService::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_kv_5fdbserver_2eproto);
  return file_level_service_descriptors_kv_5fdbserver_2eproto[1];
}
...
void KvDBPutService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::PROTOBUF_NAMESPACE_ID::Message* response,
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_kv_5fdbserver_2eproto[1]);
  switch(method->index()) {
    case 0:
      Put(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::proto::KvDBRequest*>(
